        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                    ...
                    <a class="dropdown-item" href="<?= base_url('assets/admin/img/undraw_profile.svg'); ?>">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $this->db->count_all('admin'); ?></div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                    Jumlah Total Produk</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $this->db->count_all('product'); ?></div>
                            </div>
                            <div class="col-auto">
